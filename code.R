...
par(mfrow = c(3,2), mar = c(0,1,1,1))
plot(S1X1V21D1s$X - S1Par[1,1], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V21D2s$X - S1Par[4,1], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V21D1s$Y - S1Par[1,2], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V21D2s$Y - S1Par[4,2], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V21D1s$Z - S1Par[1,3], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V21D2s$Z - S1Par[4,3], pch = '.', ylim = c(-0.2,0.2))
...
plot(S1X1V10D1s$X - S1Par[2,1], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V10D2s$X - S1Par[5,1], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V10D1s$Y - S1Par[2,2], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V10D2s$Y - S1Par[5,2], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V10D1s$Z - S1Par[2,3], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V10D2s$Z - S1Par[5,3], pch = '.', ylim = c(-0.2,0.2))
...
plot(S1X1V05D1s$X - S1Par[3,1], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V05D2s$X - S1Par[6,1], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V05D1s$Y - S1Par[3,2], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V05D2s$Y - S1Par[6,2], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V05D1s$Z - S1Par[3,3], pch = '.', ylim = c(-0.2,0.2))
plot(S1X1V05D2s$Z - S1Par[6,3], pch = '.', ylim = c(-0.2,0.2))
##### SENSOR 6 #####
